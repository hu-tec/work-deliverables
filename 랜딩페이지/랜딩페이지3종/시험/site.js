    ...
    footerContainer.innerHTML = `
      <div class="footer-cols">
        ...
        <div class="f-info">
          ...
          <p>타임스미디어㈜  |  대표 ○○○  |  개인정보보호책임자 ○○○</p>
          <p>사업자등록번호 000-00-00000  |  통신판매업신고 제2026-서울○○-0000호</p>
          <p>주소 서울특별시 ○○구 ○○로 00, 0층 (우 00000)</p>
          <p>이메일 info@timesedu.co.kr  |  운영시간 평일 10:00 ~ 18:00 (점심 12:00~13:00)</p>
        </div>
      </div>
      <div class="copyright">© 2026 Times Media Inc. All rights reserved. — layout_redesign</div>`;
  }
})();
